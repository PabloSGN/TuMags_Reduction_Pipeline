...
#  Matrix DEModulation canculated in july 2025. THIS OVERWRITES demod_matrices
demod_matrices = {
    "517": {
        0: np.array([
            [0.2827, 0.2957, 0.2244, 0.2032],
            [-0.4583, -0.4737, 0.3590, 0.4966],
            [0.5021, -0.5393, 0.3760, -0.3525],
            [0.3797, -0.3160, -0.5652, 0.5028]
        ]),
        1: np.array([
            [0.1953, 0.1822, 0.3165, 0.3127],
            [0.3970, 0.4640, -0.3967, -0.5447],
            [-0.5628, 0.6079, -0.3627, 0.3322],
            [-0.4175, 0.3381, 0.5304, -0.4475]
        ])
    },
    "502": {
        0: np.array([
            [0.2972, 0.2799, 0.2270, 0.2014],
            [-0.4555, -0.4412, 0.3488, 0.4741],
            [0.5281, -0.5827, 0.3814, -0.3334],
            [0.3618, -0.3113, -0.5839, 0.5356]
        ]),
        1: np.array([
            [0.1495, 0.2057, 0.3123, 0.3408],
            [0.4449, 0.3950, -0.4212, -0.5089],
            [-0.5928, 0.6597, -0.3638, 0.3140],
            [-0.3921, 0.3476, 0.5449, -0.4968]
        ])
    },
    "506": {
        0: np.array([
            [0.3020, 0.2765, 0.2305, 0.1977],
            [-0.4601, -0.4380, 0.3262, 0.4900],
            [0.5235, -0.5951, 0.3798, -0.3144],
            [0.3587, -0.3035, -0.5908, 0.5407]
        ]),
        1: np.array([
            [0.1585, 0.1869, 0.3237, 0.3413],
            [0.4190, 0.4115, -0.3897, -0.5408],
            [-0.6049, 0.6849, -0.3628, 0.3040],
            [-0.4042, 0.3329, 0.5579, -0.4803]
        ])
    }
}
# ------------------------------  CODE  ------------------------------------------ # 
