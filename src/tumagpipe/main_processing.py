...
def compute_level_05(observation_id, images_paths, observing_mode, dark_current, flat_field, field_stop, output_folder):
...
def compute_level_06(Sunrise_id, flat_fielded_data, header, obsname, output_folder, obsmode = None, zkes = None):
...
def compute_level_08_and_09(data, header, obsname, reductionlevel, output_folder, acc = 0.01):
...
def compute_level_1_and_higher(aligned_data, header, obsname, reductionlevel, shifts, output_folder):
...
def process_observation(Compute_reduction_levels, output_folder, csvfile, Tstart, observation_id, picklefile = None, oc = None, dc = None, ff = None, zkes = None, fits_file_05 = None,
    ...
    try:
        ...
        if Compute_reduction_levels["L0.5"]:
            ...
            fits_file_05 = compute_level_05(observation_id, images_paths=images_paths, observing_mode=ObsMode, 
                                            dark_current=dc, flat_field=ff, field_stop=fs, output_folder=output_folder)
        ...
        if Compute_reduction_levels["L0.6"]:
            ...
            sunrise_id = observation_id.split("_")[0]
            fits_file_06 = compute_level_06(sunrise_id, flat_fielded_data = om_corr, header = header_05, 
                                            obsname = obsname_base, output_folder=output_folder, obsmode = ObsMode, zkes = zkes)
        ...
        if Compute_reduction_levels["L0.9"]:
            ...
            fits_file_09 = compute_level_08_and_09(data = reconstructed, header=header_06, 
                                                obsname=obsname_base, reductionlevel=0.9, output_folder = output_folder)
        ...
        if Compute_reduction_levels["L1.0"]:
            ...
            fits_file_10 = compute_level_1_and_higher(aligned_data=aligned, header=header_08, 
                                                    obsname=obsname_base, reductionlevel=1.0, shifts=shifts, output_folder=output_folder)
        ...
        if Compute_reduction_levels["L1.1"]:
            ...
            fits_file_11 = compute_level_1_and_higher(aligned_data=aligned, header=header_09, 
                                                    obsname=obsname_base, reductionlevel=1.1, shifts=shifts, output_folder=output_folder)
