...
import numpy as np
import pandas as pd
import tumagpipe.zernike as zk
import tumagpipe.math_func2 as mf
import sys
import os
import time
import scipy
...
def object_estimate(ima,a,a_d,wind=True,cobs=0,cut=29,low_f=0.2,tiptilt=False,
                    noise=None,reg1=0,reg2=1,inst='tumag'):
    """
...
def object_estimate_jitter(ima,sigma,a,a_d,cobs=0,wind=True,
                           low_f=0.2,tiptilt=False,noise=None,
...
def restore_ima(ima,zernikes,pd=0,low_f=0.2,noise=None,reg1=0.05,
                reg2=1,cobs=32.4):
    """
