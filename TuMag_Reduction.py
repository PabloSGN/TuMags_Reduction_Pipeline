...
# Testeo
daks_c1 = sorted(glob.glob(f"/home/pablo/Desktop/TumagPipeline/test_data/flats_Examples/obs1/*_0_*")) 
daks_c2 = sorted(glob.glob(f"/home/pablo/Desktop/TumagPipeline/test_data/flats_Examples/obs1/*_1_*")) 
...
dc = compute_master_darks(daks_c1, daks_c2, fs_c1, fs_c2, True)
...
axs[0, 0].imshow(dc[0], cmap = "gray", vmin = 2000, vmax = 2150)
axs[0, 1].imshow(dc[1], cmap = "gray", vmin = 2000, vmax = 2150)
